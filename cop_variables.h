...
// antene
int n_antene_mn,n_antene_mx;
int n_antene_0,n_antene_1,n_antene_2,n_antene_3;
...
// bot
int n_bot_0,n_bot_1,n_bot_2;
PetscReal z_bot_0,z_bot_1,z_bot_2;

// points of rotation
int n_leg_1_rot,n_leg_2_rot,n_leg_3_rot;
int n_leg_4_rot,n_leg_5_rot,n_leg_6_rot;
int n_leg_7_rot,n_leg_8_rot,n_leg_9_rot;
int n_leg_10_rot,n_leg_11_rot,n_leg_12_rot;
...
int n_tail;
int n_antene;
int n_leg1,n_leg2,n_leg3;
int n_leg4,n_leg5,n_leg6;
int n_leg7,n_leg8,n_leg9;
int n_leg10,n_leg11,n_leg12;

/*  Node aray of each part of cop */
int *nv_tail, *nv_antene;
int *nv_leg1, *nv_leg2, *nv_leg3;
int *nv_leg4, *nv_leg5, *nv_leg6;
int *nv_leg7, *nv_leg8, *nv_leg9;
int *nv_leg10, *nv_leg11, *nv_leg12;
